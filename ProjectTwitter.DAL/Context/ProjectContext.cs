...
using ProjectTwitter.Map.Option;
...
namespace ProjectTwitter.DAL.Context
{
    public class ProjectContext : DbContext
    {
        public ProjectContext()
        {
            Database.Connection.ConnectionString = "Server=302-0006;Database=ProjectTwitter;uid=sa;pwd=1234;";
        }
